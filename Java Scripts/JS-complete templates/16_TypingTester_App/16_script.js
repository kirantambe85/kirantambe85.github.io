...
var greetMessageElement = document.querySelector('.cong-section');
...
// Event Listener for Text Area to start the timer
...
// Event Listener for Text Area to check the Spelling
textAreaElement.addEventListener('keyup',function() {
    ...
    if(textEntered !== ''){
        if(textEntered === originalText){
            ...
            greetMessageElement.style.display = 'block';
        }
        else{
...
resetButtonElement.addEventListener('click',function() {
    ...
    greetMessageElement.style.display = 'none';
    // Get the Random Text
    getRandomString();
});
